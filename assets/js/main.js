...
function renderPersonPage() {
  ...
  container.innerHTML = `
    ...
    <section class="section content-grid">
      ...
      <article class="content-card">
        <h2>אטימולוגיה ופירוש השם</h2>
        <p>${person.etymology}</p>
      </article>
      <article class="content-card">
        <h2>תחומי פעולה</h2>
        <div class="tags">${person.fields.map(field => `<span class="tag">${field}</span>`).join("")}</div>
      ...
      <article class="content-card">
        <h2>השפעה על יהודי ארץ ישראל</h2>
        <p>סעיף זה מיועד להרחבה מחקרית: כיצד הדמות השפיעה על חיים יהודיים בארץ ישראל, על מוסדות, קהילות, התיישבות, לימוד תורה, כלכלה או זהות יהודית.</p>
      </article>
      <article class="content-card">
        <h2>השפעה על יהודי התפוצות</h2>
        <p>סעיף זה מיועד להרחבה מחקרית: כיצד הדמות השפיעה על קהילות יהודיות בעולם, על זכויות, חינוך, הצלה, קשרים דיפלומטיים או הנהגה קהילתית.</p>
      </article>
      <article class="content-card">
        <h2>מקורות ותמונות</h2>
        <p>בשלב הבא נוסיף לכל דמות מקורות נפרדים, קישורים לתמונות בנחלת הכלל, ושמות קבצים מוכנים לגיטהאב.</p>
      </article>
    </section>
  `;
}
